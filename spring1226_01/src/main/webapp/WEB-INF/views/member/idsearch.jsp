		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<h3>아이디 찾기</h3>
					<form method="post" action="idsearch" name="idsearchFrm">
					<div class="informbox">
						<div class="inform">
							<ul>
								...
								<li><input type="password" id="pw" name="pw" class="emailType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='emailType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
