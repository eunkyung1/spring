	...
	<div id="header">
		...
		<div id="snbBox">
			...
			<div id="snb">
					...
					<c:if test="${session_id!=null }">
					<li><a href="#">${session_nicName }님</a></li>
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="customer">
					...
					<div class="replyBox">
						<!-- 반복 시작 -->
						<c:forEach var="cdto" items="${map.list}">
						<ul>
							<li class="name">${cdto.id } <span>${cdto.cdate}</span></li>
							<li class="txt">${cdto.ccontent }</li>
							<c:if test="${cdto.id == session_id }">
							<li class="btn">
								<a class="rebtn" style="cursor:pointer;">수정</a>
								<a class="rebtn" style="cursor:pointer;">삭제</a>
							</li>
							</c:if>
						</ul>
						</c:forEach>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a href="#" class="nbtnbig">수정</a></li>
