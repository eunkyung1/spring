			...
			<div id="contents">
				<div id="customer">
					...
					<script>
						$(function(){
							...
							$(document).on("click",".delBtn",function(){
								//alert("cno 위치 점 : "+$(this).parent().parent().attr("id"));
							...
							$(document).on("click",".updateBtn",function(){
								alert("수정을 합니다.");
								//alert("cno : "+ $(this).parent().parent().attr("id") );
								//alert("cdate : "+ $(this).parent().parent().find("span").text());
								//alert("ccontent : "+ $(this).parent().prev().text());
								...
								hdata+='<li class="btn">';
								hdata+='<a class="rebtn saveBtn">저장</a>';
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span class="orange">${map.list.size()}</span> 개의 댓글이 달려있습니다.</p>
								<p class="password">비밀번호&nbsp;&nbsp;<input type="password" class="replynum" /></p>
								<textarea class="replyType"></textarea>
							</li>
							<li class="btn"><a class="replyBtn" id="replyBtn">등록</a></li>
						</ul>
					...
					<!-- 반복 시작 -->
					<div class="replyBox">
						<c:forEach var="ecomment" items="${map.list}">
						<ul id="${ecomment.cno}">
