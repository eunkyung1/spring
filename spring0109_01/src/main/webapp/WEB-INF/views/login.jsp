...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a80cbb0b355a5107849b34c31f0cd9bd&redirect_uri=http://localhost:8000/kakao/oauth">
      <li class="kakao"></li>
      </a>
      <li class="naver"></li>
