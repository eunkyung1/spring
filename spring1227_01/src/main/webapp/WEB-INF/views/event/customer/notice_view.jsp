			...
			<div id="contents">
				<div id="customer">
					...
					<script>
						$(function(){
							...
							$(document).on("click",".delBtn",function(){
								//alert("부모의 부모 id : "+$(this).parent().parent().attr("id")); //li에서 ul를 찾아라.
								//alert("부모의 부모 id : "+$(this).closest("ul").attr("id")); //근처 ul값을 찾아라
								let ccount =Number($(".ccount").text());
							...
							$(document).on("click",".updateBtn",function(){
								...
								alert("댓글수정을 합니다.");
								//alert("부모의 부모 id : "+$(this).parent().parent().attr("id")); //li에서 ul를 찾아라.
								//alert("내용 : "+$(this).parent().prev().text()); //li에서 ul를 찾아라.
								//alert("아이디와 날짜 : "+$(this).parent().prev().prev().text()); //prev 
								//alert("날짜 : "+$(this).parent().parent().find("span").text()); //li에서 ul를 찾아라.
								...
								hdata += '<li class="btn">';
								hdata += '<a class="rebtn savaBtn">저장</a>&nbsp';
							...
							$(document).on("click",".cancelBtn",function(){
								...
								let id = "${session_id}";
								let cdate = $(this).parent().parent().find("span").text();
								//parent() - 부모, find() - 현재 태그에 포함된 id를 찾음.
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span class="orange ccount">${map.commentlist.size() }</span> 개의 댓글이 달려있습니다.</p>
