				...
				<div id="member">
					...
					<div class="memberbd">
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
							<form method="post" name="frm" action="/member/step04">
								<tr>
									...
									$(function(){
										...
										$(".sbtnMini").click(function(){
											...
											if(!idpattern.test(id)){
												alert("아이디는 영문자 또는 숫자를 3-10자리를 사용하셔야 합니다.")
												return false;
											}
											
											//비밀번호 영문자,숫자,특수문자 체크
											if(!pwpattern.test(pw)){
												alert("비밀번호는 영문자, 숫자, 특수문자 1개 이상 입력하셔야 합니다.")
												return false;
											}
											...
											let hobbyCount = $("input[type=checkbox]:checked").length;
											if(hobbyCount<1){
												alert("취미항목은 1개이상 체크하셔야 합니다. ");
												return false;
											}												
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>
												<span class="mvalign " id="mvalign"></span>
								...
								$(function(){
									$("#pw2").keyup(function(){
										...
										let pw2 = $("#pw2").val();
									if(pw1==pw2){
										$("#mvalign").removeClass("black");
										$("#mvalign").addClass("orange");
										$("#mvalign").html("* 비밀번호가 일치합니다.");
									}else{
										$("#mvalign").removeClass("orange");
										$("#mvalign").addClass("black");
										$("#mvalign").html("* 비밀번호가 일치하지 않습니다.");
									}
									});//keyup
								});//jquery
								...
								<tr>
									...
									<td>
										...
										<ul class="pta">
											...
											<li><input type="text" class="w74" id="phone2" name="phone2" maxlength="4" /> <span class="valign">-</span>&nbsp;</li>
									...
									<td>
										<ul class="pta">
											<li>
												<ul class="baseQues">
													<li>
														<input type="radio" name="gender" id="Male" value="Male" class="radio_t" checked="checked"/><label for="Male">남성</label>
													</li>
													<li>
														<input type="radio" name="gender" id="Female" value="Female" class="radio_t" /><label for="Female">여성</label>
													</li>
												</ul>
											</li>
										</ul>
