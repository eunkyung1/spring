...
<html>
	...
	<body>
		...
		<div class="searchDiv">
		  ...
		  <form action="list" method="get" name="searchFrm">
		...
		<table>
		   <colgroup>
			...
			<c:forEach var="empDepDto" items="${list}">
			<tr>
			  <!-- 사원테이블  -->
			  <td>${empDepDto.empDto.employee_id}</td>
			  <td>${empDepDto.empDto.emp_name}</td>
			  <td>${empDepDto.empDto.email}</td>
			  <td>${empDepDto.empDto.hire_date}</td>
			  <td>${empDepDto.empDto.salary}</td>
			  <td>${empDepDto.empDto.department_id}</td>
			  <!-- 부서테이블 -->
			  <td>${empDepDto.depDto.department_id}</td>
			  <td>${empDepDto.depDto.department_name}</td>
			  <td>${empDepDto.depDto.parent_id}</td>
			  <td>${empDepDto.depDto.create_date}</td>
